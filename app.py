...
def index():
    ...
    if data_frames:
        ...
        latest_balances['24-Hour Quil Per Day'] = last_24_hours_quil_per_day.fillna('').values

        last_24_hours_quil_per_hour = calculate_last_24_hours_quil_per_hour(combined_df)
        latest_balances['24-Hour Quil Per Hour'] = last_24_hours_quil_per_hour.fillna('').values
